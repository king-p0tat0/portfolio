          ...
          sections: [
            {
              title: '핵심기능',
              bullets: [
                '한 화면에서 프로젝트를 빠르게 탐색하고, 모달을 통해 깊이 있게 확인하는 구조',
                '결과물을 직관적으로 보여주는 이미지 갤러리와 확대 보기 기능',
                '실기기 기준으로 다듬은 모바일 스와이프·탭 인터랙션',
                'S3·CloudFront 기반의 정적 배포 환경 구축',
              ],
            },
            {
              title: 'UX 포인트',
              bullets: [
                '초기 로딩 깜빡임을 최소화한 안정적인 첫 화면 경험',
                '상세 보기에서도 현재 맥락이 유지되는 탐색 흐름',
                '터치 타겟과 간격을 조정해 자연스러운 모바일 조작감 구현',
                '설명보다 결과물 중심의 콘텐츠 배치',
                '세로·가로 모드 모두 일관된 반응형 레이아웃 유지',
              ],
            },
          ],
        },
          ...
          sections: [
            {
              title: '반응형 대응의 한계',
              text: `
                이번 포트폴리오는 데스크톱 환경을 중심으로 설계·구현하다보니 다양한 해상도와 모바일 환경까지 충분히 고려하지 못했습니다. 모바일·태블릿 환경을 기준으로 레이아웃을 다시 설계하고, Grid와 Flex 기반의 반응형 구조를 정리해 해상도에 따라 콘텐츠 밀도와 인터랙션을 조정하는 방향으로 보완해 나가고자 합니다.
              `,
            },
          ],
        },
